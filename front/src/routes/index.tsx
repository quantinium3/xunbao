		...
		<div className="flex justify-center h-screen lg:h-[66vh] flex-col space-y-2 px-4 pt-10">
			...
			<div className="flex gap-6 flex-col items-center mt-4">
				<button
					...
					onClick={() => nav({ to: "/play" })}
				>
					<img src="/assets/button-outline.webp" alt="" className="w-32 md:w-48 group-hover:scale-110 transition-transform sepia-[0.3] hue-rotate-30 group-hover:sepia-[0.5] group-hover:hue-rotate-40" />
